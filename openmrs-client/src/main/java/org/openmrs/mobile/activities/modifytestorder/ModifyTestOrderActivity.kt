...
@AndroidEntryPoint
class ModifyTestOrderActivity : ACBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var fragment = supportFragmentManager.findFragmentById(R.id.testOrderFormFrame) as ModifyTestOrderFragment?
        if (fragment == null) {
            fragment = ModifyTestOrderFragment.newInstance(order)
        }
    ...
    companion object {
        fun newIntent(context: Context, order: OrderGet) =
            Intent(context, ModifyTestOrderActivity::class.java).apply {
