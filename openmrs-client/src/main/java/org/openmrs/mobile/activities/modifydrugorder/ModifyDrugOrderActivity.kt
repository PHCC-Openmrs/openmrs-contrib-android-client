...
@AndroidEntryPoint
class ModifyDrugOrderActivity : ACBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var fragment = supportFragmentManager.findFragmentById(R.id.drugOrderFormFrame) as ModifyDrugOrderFragment?
        if (fragment == null) {
            fragment = ModifyDrugOrderFragment.newInstance(order)
        }
    ...
    companion object {
        fun newIntent(context: Context, order: OrderGet) =
            Intent(context, ModifyDrugOrderActivity::class.java).apply {
